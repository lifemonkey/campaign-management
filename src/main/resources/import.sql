...
INSERT INTO transaction_type (id,name,description,external_id,status,trans_type_english,trans_type_swahili,created_by,created_date,last_modified_by,last_modified_date) VALUES (1,'Agent activate service','Agent activate service',1,'Agent activate service','Wakala kuwezesha huduma','system',to_date('2022-11-25 18:07:08','YYYY-MM-DD HH24:MI:SS'),'system',to_date('2022-11-25 18:07:08','YYYY-MM-DD HH24:MI:SS'));
INSERT INTO transaction_type (id,name,description,external_id,status,trans_type_english,trans_type_swahili,created_by,created_date,last_modified_by,last_modified_date) VALUES (2,'Bo phan kinh doanh them Merchant','Bo phan kinh doanh them Merchant',1,'Business unit adds merchant','Kitengo cha blashara kuongeza mfanyablashara wa jumla','system',to_date('2022-11-25 18:07:08','YYYY-MM-DD HH24:MI:SS'),'system',to_date('2022-11-25 18:07:08','YYYY-MM-DD HH24:MI:SS'));
INSERT INTO transaction_type (id,name,description,external_id,status,trans_type_english,trans_type_swahili,created_by,created_date,last_modified_by,last_modified_date) VALUES (3,'Bo phan kinh doanh them KHDN','Bo phan kinh doanh them KHDN',1,'Business unit adds business customer','Kitengo cha blashara kuongeza Mteja wa blashara','system',to_date('2022-11-25 18:07:08','YYYY-MM-DD HH24:MI:SS'),'system',to_date('2022-11-25 18:07:08','YYYY-MM-DD HH24:MI:SS'));
