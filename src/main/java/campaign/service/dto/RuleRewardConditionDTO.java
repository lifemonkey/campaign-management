...
public class RuleRewardConditionDTO {
    ...
    private RewardConditionRewardDTO reward;
    ...
    public RuleRewardConditionDTO() {
    }

    public RuleRewardConditionDTO(RewardCondition rewardCondition) {
        ...
        if (rewardCondition.getReward() != null) {
            this.reward = new RewardConditionRewardDTO(rewardCondition.getReward());
        }
    ...
    public RewardConditionRewardDTO getReward() {
        return reward;
    }

    public void setReward(RewardConditionRewardDTO reward) {
        this.reward = reward;
    }
