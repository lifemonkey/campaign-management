package campaign.config.timezone;

import campaign.HalopesaApp;
import campaign.repository.timezone.DateTimeWrapper;
import campaign.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = HalopesaApp.class)
